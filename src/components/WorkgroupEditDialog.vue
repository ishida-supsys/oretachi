...
<i18n lang="json">
{
  "en": {
    ...
    "autoReturnHomeAfterTaskHint": "After a task finishes, switch back to the Home tab once the main window has been unfocused for 5 seconds. It waits while the window is focused, and the countdown restarts each time you leave.",
  ...
  "ja": {
    ...
    "autoReturnHomeAfterTaskHint": "タスク完了後、メインウィンドウが非フォーカスのまま5秒経つとホームタブへ戻ります。フォーカス中は待機し、フォーカスを外すたびにカウントダウンし直します。",
