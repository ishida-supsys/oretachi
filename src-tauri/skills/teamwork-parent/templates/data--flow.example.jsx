...
const DEPENDENCIES = [
  ...
  { from: 'task-140', to: 'task-141', kind: 'blocks',
    stopConditions: [
      { id: 'sc-e0-1', text: '#140 のAPI仕様を見て #141 の着手可否を判断', checked: false },
    ] },
  ...
  // 実行済み(緑 ☑): 線は通常色に戻り、中点バッジだけが緑の ☑ になる。
  // #140 と #142 を同じ行に置くことで、この破線が #141 のボックスを横切らないようにしている
  { from: 'task-140', to: 'task-142', kind: 'informs',
    stopConditions: [
      { id: 'sc-e2-1', text: '#140 のイベント名が #142 の検証手順と噛み合うか確認', checked: true, checkedAt: '2026-08-16 09:50' },
    ] },
];
